...
import { ChevronDown, Check, Settings as SettingsIcon, Box } from "lucide-react";
import { useDesignerContext, useStyles, useItems, useProjects } from "@/hooks/useDesigner";
import { useState } from "react";
import SettingsDialog from "./SettingsDialog";
import { Skeleton } from "@/components/ui/skeleton";

export default function LibraryPanel() {
  const { selectedStyleId, setSelectedStyleId, selectedItemId, setSelectedItemId, setCurrentPrompt } = useDesignerContext();
      ...
      <div className="p-6 border-b border-border bg-sidebar">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <Badge variant="secondary" className="mt-1 font-medium bg-accent/20 text-accent-foreground border-accent/20">Garden Furniture</Badge>
          </div>
        </div>
      </div>
